...
| `page[offset]` | Optionsal | `integer` | The number of records to offset the results by. See [Pagination](/docs/api-overview/pagination).                                                                                                                                                                                                                                                            |
...
| `In` | Checks if the values are included in the specified string. If they are, the condition is true. | `id`, `name`, `sku`, `slug`, `mpn`, `upc_ean` | `sfilter=in(id,some-id)` |
