...
For an overview of how payments work in Commerce, see [Payments](/docs/payment/payments).

:::caution
If the order total is zero or the payment is processed through non-supported payment providers, you can configure [Manual Gateway](/docs/payment/paying-for-an-order/manual-payments) to process your store payments.
:::
