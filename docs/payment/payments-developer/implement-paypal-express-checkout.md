...
- Ensure that you have a Commerce account, and Client ID and Client Secret of your store available from [Commerce Manager](/docs/getting-started/cm-overview).
- Get An [access token](/docs/api-overview/your-first-api-request#get-an-access-token).
...
- Onboard PayPal Express Checkout. See [Onboarding PayPal Express Checkout](/docs/payment/payment-gateway-cm/paypal).
...
1. Checkout using a customer object. For more information, see [Checkout](/docs/checkout/checkout).

    :::note
    Ensure that you use a valid country code. The URL used in this call is `http://localhost/v2/carts/{{cartID}}/checkout`.
    :::

1. Use the following request example to set up `purchase` from PayPal Express Checkout gateway. For more information, see [PayPal Express Checkout Payments](/docs/payment/paying-for-an-order/paypal-express-checkout-payments).
...
1. Use the following request example to setup authorization from PayPal Express Checkout gateway. For more information, see [PayPal Express Checkout Payments](/docs/payment/paying-for-an-order/paypal-express-checkout-payments).
...
1. Capture the authorized funds. See [Capture a Transaction](/docs/payment/transactions/capture-a-transaction).
1. Go to Commerce Manager.
1. Go to **Orders**, and find the order. The payment status shows `Paid`, and the **Transaction** status shows `Complete`.

### `Refund` workflow

You can `refund` the `paid` order. See [Refund a Payment](/docs/payment/transactions/refund-a-transaction).
...
1. Make a note of the **Email ID**, **System Generated Password**, and **Account ID** to set up your PayPal Express Checkout for commerce cloud. See [Configure PayPal Express Checkout](/docs/payment/payment-gateway/configure-paypal-express-checkout).
...
- [PayPal Express Checkout Payments](/docs/payment/paying-for-an-order/paypal-express-checkout-payments)
