...
:::note
Read our [Quick Start guide](/docs/api-overview/your-first-api-request) on how to make your first API request.
:::
...
For more details on token formatting, see [Content Type](/docs/api-overview/content-type).
