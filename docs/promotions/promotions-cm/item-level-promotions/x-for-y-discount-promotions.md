---
title: Creating X for Y Discount Promotions
nav_label: X for Y Discount Promotions
sidebar_position: 1
---
...
1. In the **Define schema** section, do the following.
    1. In the **X/Y values** subsection:
        1. Click **Specify X/Y values**.
            ...
            The **Add X and Y Value** window is displayed.
        1. In the **X value** and **Y value** fields, specify the values for X and Y. 
            
            For example, for a promotion 2 for 1, **X value** is 2 and **Y value** is 1.
        1. Click **Save**.
