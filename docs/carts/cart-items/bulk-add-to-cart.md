...
- [Add Product to Cart](/docs/carts/cart-items/add-product-to-cart)
- [Add Custom Item to Cart](/docs/carts/cart-items/add-custom-item-to-cart)
...
| `shipping_group_id` | Optional | `string` | The shipping group ID to be added. See [Get a Cart Shipping Group by ID](/docs/shipping-groups/shipping-groups-api/get-a-cart-shipping-group-by-id). |
