...
For more information, see [**create a Catalog**](#tag/Catalogs/operation/createCatalog).
...
|  <div style="width:100px">Object</div> |  <div style="width:60px">Product/Node</div> |  <div style="width:290px">Description</div> |
| --- | --- | --- |
