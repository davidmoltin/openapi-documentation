...
1. Create a price modifier. You must give the price modifier a unique name. For more information, see [Create a Price Modifier](/#tag/Price-Book-Modifiers/operation/createPriceModifier).
