---
id: flows-service-api
title: "Flows Service API"
...
<h1 className={"openapi__heading"}>Flows Service API</h1>
...
> **Warning**: 
>In an organization, not all resources are available. See [**Extend a resource**](#extend-an-existing-resource) for a list of organization resources that can be extended.

> **Warning**:
> If you store any sensitive Personal Identifiable Information (PII) or non-public data on your site, ensure that you do not use this data in flows to avoid potential access to the data. For more information, see [**Permissions**](https://elasticpath.dev/docs/commerce-cloud/authentication/Tokens/permissions).
