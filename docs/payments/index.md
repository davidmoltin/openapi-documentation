...
:::note
- If you are using Elastic Path Commerce Cloud, follow the steps in [Configure Elastic Path Payments Powered by Stripe](/docs/payment/payment-gateway/configure-elastic-path-payments-powered-by-stripe) documentation. For an overview of how payments work in Elastic Path Commerce Cloud, see [Payments](/docs-repo/elasticpath-dev-site/src/pages/docs/commerce-cloud/payments/payments).
